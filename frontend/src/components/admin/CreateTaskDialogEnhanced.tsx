...
import { TASK_CATEGORIES, getTaskTemplate, validateTaskForm, generateTaskPayload, TaskTemplate, TaskField, TaskFormData } from '../../utils/taskTemplates';
...
export function CreateTaskDialog({ open, onClose, onTaskCreated, users }: CreateTaskDialogProps) {
  ...
  const handleSubmit = async () => {
    ...
    const allErrors = validateTaskForm(formData, selectedTemplate);
    ...
    try {
      ...
      const payload = generateTaskPayload(formData, selectedTemplate);
  ...
  const renderFieldInput = (field: TaskField) => {
